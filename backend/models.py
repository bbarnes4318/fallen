...
class VerificationEvent(Base):
    ...
    # Pre/Post CLAHE provenance hashes (v3.1 — chain of custody at each preprocessing stage)
    probe_aligned_crop_hash_pre_clahe = Column(String(64), nullable=True)
    gallery_aligned_crop_hash_pre_clahe = Column(String(64), nullable=True)
    probe_aligned_crop_hash_post_clahe = Column(String(64), nullable=True)
    gallery_aligned_crop_hash_post_clahe = Column(String(64), nullable=True)
