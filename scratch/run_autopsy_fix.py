...
def run_autopsy():
    ...
    out_dir = "c:/Users/jimbo/OneDrive/Documents/facial/scratch/autopsy_output_after_structural_fix"
    ...
    print(f"Autopsy complete. Accepted: {len(marks)}")
    cr = [m for m in marks if m.get("channel") == "structural_depression"]
    print(f"structural_depression marks accepted: {len(cr)}")
